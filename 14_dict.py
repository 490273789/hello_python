...
print("dict_var:", dict_var)  # {'name': 'Alice', 'age': 30, 'city': 'New York', 'job': 'Engineer'}
# 字典的修改
dict_var['age'] = 31
print("dict_var:", dict_var)  # {'name': 'Alice', 'age': 31, 'city': 'New York', 'job': 'Engineer'}
# 字典的删除
del dict_var['city']
...
print("dict_var_copy:", dict_var_copy)  # {'name': 'Alice', 'age': 30, 'city': 'New York'}
# fromkeys() 创建字典
...
print("dict_var.get('job'):", dict_var.get('job'))  # None
# pop() 删除字典的键值对
dict_var = {"name": "Alice", "age": 30, "city": "New York"}
...
print("dict_var.setdefault('job', 'Engineer'):", dict_var.setdefault('job', 'Engineer'))  # Engineer
...
print("dict_var1:", dict_var1)  # {'name': 'Alice', 'age': 30, 'city': 'New York', 'job': 'Engineer'}
# 字典的推导式
...
print("dict_var:", dict_var)  # {0: {0: 0, 1: 0, 2: 0}, 1: {0: 0, 1: 1, 2: 2}, 2: {0: 0, 1: 2, 2: 4}}
