...
# 正常解包的用法
def rest_package(name, age):
    print(f"rest_package: {name}, {age}")


# / 前必须使用位置参数， *后必须使用关键字参数
def print_letter(a, b, c, d, e):
    print(f"print_letter: {a} {b} {c} {d} {e}")


print_letter(1, 2, 3, 4, e=5)


rest_package(**{"name": "wsn", "age": 18})
